...
When a proposal is ready for review, the page ends with a disabled **Ajouter au bon de demande** placeholder. It performs no persistence, transmission, or prescription action in v0.
